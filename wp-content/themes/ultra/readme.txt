...
* Updated styling for sticky menu button.
* Removed RGBA setting CSS not needed.
* Updated Tested up to tag.
* Minor formatting updates.
* Premium: Expanded Customizer Content Header styles to WooCommerce.

= 1.6.5 - 08 July 2023 =
* Added before and after site branding action hooks.
* Updated SiteOrigin settings with new classes for web fonts and custom CSS.
* Updated "Tested up to" tag to 6.0 in readme.txt, style.scss, and style.css files.
* Replaced font-family "Muli" with "Mulish" in style.css and various other files.
* Updated SO Settings font handling in customizer.php and fonts.php.
* Updated calendar footer styling in _widgets.scss and style.css.
* Added function exists check for ultra_footer_copyright_text_sub function in functions.php.
* Updated hc-sticky to 2.2.7.
* Removed webkit-overflow-scrolling property from _elements.scss and style.css.
* Updated Google Fonts array in google-fonts.php.
* Removed redundant font file "google-fonts.php".
* Updated Footer Attribution setting description in settings.php.
* Minor formatting updates in various files.

= 1.6.4 - 10 March 2022 =
* Improved menu touch device compatibility.
* Related Posts: Prevented an notice if no categories exist.
* Updated `Tested up to` tag.
* Developer: Added a `ultra_after_nav` action hook.
* Developer: Added a `function_exists` check for `ultra_slider_page_setting_metabox`.
* Developer: Added a `function_exists` check for `ultra_render_slider`.
